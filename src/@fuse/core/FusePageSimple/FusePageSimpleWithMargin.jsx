 ...
 */
const FusePageSimpleWithMargin = forwardRef((props, ref) => {
	const {
		scroll = 'page',
		className,
		header,
		...
		<>
			...
			>
				<div className="z-10 flex h-full flex-auto flex-col">
					<div className="FusePageSimple-wrapper md:mx-[160px]">
						{leftSidebarContent && (
...
export default memo(styled(FusePageSimpleWithMargin)``);
