...
// console.log('navDATA', estatesNavigationConfig)
...
} = navigationAdapter.getSelectors((state) => state.estatenavigation);
/**
 * The navigation slice
 */

export const estatesNavigationSlice = createSlice({
	name: 'estatenavigation',
	initialState,
	reducers: {
...
rootReducer.inject(estatesNavigationSlice);
estatesNavigationSlice.injectInto(rootReducer);
export const { setNavigation, resetNavigation } = estatesNavigationSlice.actions;
...
export default estatesNavigationSlice.reducer;
