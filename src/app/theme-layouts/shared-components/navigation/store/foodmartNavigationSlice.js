...
import foodmartNavigationConfig from 'app/configs/foodmartNavigationConfig';
...
} = navigationAdapter.getSelectors((state) => state.forodmartnavigation);
/**
 * The navigation slice
 */

export const foodmartNavigationSlice = createSlice({
	name: 'forodmartnavigation',
	initialState,
	reducers: {
...
rootReducer.inject(foodmartNavigationSlice);
foodmartNavigationSlice.injectInto(rootReducer);
export const { setNavigation, resetNavigation } = foodmartNavigationSlice.actions;
...
export default foodmartNavigationSlice.reducer;
