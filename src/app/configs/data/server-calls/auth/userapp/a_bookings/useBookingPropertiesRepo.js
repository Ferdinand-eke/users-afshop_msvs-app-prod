import {
	getAllAmenitiesApi,
	getAllBookingsPropertyApi,
	getBookingPropertyApi
} from 'app/configs/data/client/RepositoryClient';
import { useQuery } from 'react-query';

export default function useGetAllBookingProperties(filters = {}) {
	return useQuery(['__bookingProps', filters], () => getAllBookingsPropertyApi(filters), {
...
export function useGetBookingProperty(propertyId) {
	...
	return useQuery(['__bookingProps', propertyId], () => getBookingPropertyApi(propertyId), {
		enabled: Boolean(propertyId)
		// staleTime: 2000,
	});
}

export function useGetAllAmenities(filters = {}) {
	return useQuery(['__bookingProps', filters], () => getAllAmenitiesApi(filters), {
		keepPreviousData: true, // Keep showing previous data while fetching new filtered data
		staleTime: 20000 // Consider data fresh for 20 seconds
	});
} // (Msvs => Done)
