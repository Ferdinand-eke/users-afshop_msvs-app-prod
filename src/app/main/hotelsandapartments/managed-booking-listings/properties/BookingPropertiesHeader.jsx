...
function BookingPropertiesHeader() {
	...
	return (
		<div className="flex space-y-12 sm:space-y-0 flex-1 w-full items-center justify-between py-8 sm:py-16 px-16 md:px-24">
			...
			>
				<Typography className="text-24 md:text-32 font-extrabold tracking-tight">Managed Bookings Listings</Typography>
			...
			<div className="flex flex-1 items-center justify-end space-x-8">
				...
				>
					...
					>
						...
						<span className="mx-4 sm:mx-8">Add Property For Booking Listing</span>
					</Button>
				</motion.div>
			</div>
		</div>
