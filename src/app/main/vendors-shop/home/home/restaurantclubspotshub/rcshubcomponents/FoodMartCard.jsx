 ...
 * Displays restaurant/food mart listing with image slider
 * Based on BookingCard design pattern
 */
        ...
        <div className="relative h-160 overflow-hidden">
          {images.length > 0 ? (
            <img
              ...
              className="w-full h-full object-cover transition ease-in-out delay-150 hover:scale-105"
            />
          ) : (
