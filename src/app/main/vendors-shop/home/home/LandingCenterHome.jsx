        ...
        <div className=" gap-y-32 md:gap-y-0 md:gap-x-24 w-full max-w-sm md:max-w-4xl -mt-64 sm:-mt-120 z-999">
          <div className=" flex flex-col  container mx-auto p-4">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4 h-[350px] mb-64 md:mb-8">
              <div className="hidden md:inline md:col-span-3 bg-white p-4 rounded-lg shadow overflow-scroll xs:h-[150px] mb-4">
                
                 <CategoryAndTradehub />
              </div>
              <div className="md:col-span-6 h-[350px]">
                <div className="bg-orange-500 text-white p-6 rounded-lg shadow  h-full relative">
                  <h1 className="text-4xl font-bold text-black font-mono absolute">Fresh Deals</h1>
              ...
              <div className=" flex flex-col md:col-span-3 space-y-8  h-full">
                <div className="h-full bg-gray-200 rounded-4 p-4 gap-4 space-y-8">
                  ...
                  <div className="bg-white p-4 rounded-lg shadow hover:bg-orange-500 cursor-pointer">
                    <div className="flex items-center">
                      ...
                      className="font-bold text-center">Be A Merchant on Africanshops</Typography>
                    </div>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow transition ease-in-out delay-150  hover:scale-105 cursor-pointer">
                    <div className="flex items-center">
                ...
                <div className="hidden md:inline bg-orange-500 hover:bg-orange-800 text-white p-4 rounded-lg shadow h-full">
            ...
            <div className=" flex flex-col   container mx-[auto] p-4 mt-64">
              <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mt-80 md:mt-8  ">
                <div className="bg-white p-4 rounded-lg shadow transition ease-in-out delay-150  hover:scale-105 cursor-pointer">
                  <img
                    ...
                    alt="TV & Audio Deals"
                    className="rounded-lg h-[140px] w-[100%]"
                  />
