      ...
      <div className="relative overflow-hidden px-24 pb-48 pt-32 sm:px-64 sm:pb-96 sm:pt-80">
        ...
        <div className="mt-40 flex justify-center sm:mt-80">
          <div className="w-full max-w-sm md:max-w-7xl">
            ...
            >
              {merchantPlans?.data?.data?.length > 0 ? (
                merchantPlans?.data?.data?.map((plan) => (
      ...
      <Paper className="flex flex-col items-center px-24 py-40 sm:px-64 sm:pb-80 sm:pt-72">
        <div className="w-full max-w-7xl">
          <div>
            ...
            <Typography className="mt-2 max-w-xl text-xl" color="text.secondary">
              Start managing your business using our tailored CMS tools, be efficient, spend less
              time with managinging details of your business, focus more on making business sales
            </Typography>
          </div>
