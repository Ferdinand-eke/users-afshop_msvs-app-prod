...
const changelogData = [
      ...
      <div className="text-14 p-24 border-2 rounded-16 w-full max-w-lg mt-40 mb-24">
        <ul className="list-disc">
          <Typography component="li" className="leading-loose mb-16">
            Transitioning to the new major release (v10.0.0) may present challenges, because of the
          ...
          <Typography component="li" className="leading-loose">
            Starting with the latest skeleton version of Fuse React offers a pristine base,
            facilitating a smoother transition of your codebase to the new version. This approach
            streamlines the process, making it more straightforward and efficient.
          </Typography>
        </ul>
      </div>
    ),
  },
  {
    ...
    notes: (
      <div className="text-14 p-24 border-2 rounded-16 w-full max-w-lg mt-40 mb-24">
        <ul className="list-disc">
          <Typography component="li" className="leading-loose mb-16">
            Transitioning to the new major release (v9.0.0) may present challenges due to the shift
            to TypeScript.
          </Typography>
          <Typography component="li" className="leading-loose">
            You may find this page helpful:{" "}
          ...
          <Typography component="li" className="leading-loose">
            You may also want to consider starting with the latest skeleton version of Fuse React,
            which is a clean slate, and then move your codebase to the new version. This can make
            the migration process easier and more efficient.
          </Typography>
        </ul>
      </div>
    ),
  ...
  },
  {
    ...
    fixedChanges: [
      <span>
        <i>"createBrowserHistroy is not exported from history.tsx"</i> error on windows
        environment(rare)
      </span>,
    ],
    breakingChanges: [
