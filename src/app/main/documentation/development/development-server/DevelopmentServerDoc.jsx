  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="p">
        While still in your working directory, execute the following command in the console
        application:
      </Typography>
      ...
      <Typography className="mb-16" component="p">
        You can check your console application for further information about the server. By default,
        it will be running on <b>http://localhost:3000</b> although it could change depending on
        your setup.
      </Typography>
      ...
      <div className="my-24 px-24 py-16 border-1 border-red rounded-16">
        ...
        <Typography component="div">
          In case of runtime errors on first run, make sure you are running an LTS release of
          Node.js. Delete node_modules and try again.
        </Typography>
      </div>
    </>
  );
