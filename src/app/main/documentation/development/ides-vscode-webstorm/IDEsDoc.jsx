  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="p">
        ESLint and Prettier are code quality tools that help ensure consistent code formatting and
        catch potential errors. To use them with Webstorm, we are using ESLint with{" "}
        <b>eslint-plugin-prettier</b>. To reformat the current file/folder, use the{" "}
        <b>Fix ESLint Problems</b> action. You can find it using Find Action (Cmd/Ctrl-Shift-A) or
        add a keyboard shortcut to it in <b>Preferences | Keymap</b>. Make sure that the{" "}
      ...
      <Typography className="mb-16" component="p">
        To use ESLint and Prettier with VSCode, you need to install the necessary plugins. You can
        do this using the extension sidebar in VSCode. Here is an example <b>settings.json</b>{" "}
        configuration that will apply fixes whenever a file is saved:
      </Typography>
