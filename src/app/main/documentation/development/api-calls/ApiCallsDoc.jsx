...
function ApiCallsDoc() {
  return (
    <>
      ...
      <Typography className="mb-16 leading-loose" component="p">
        You can configure global Axios defaults, such as the base URL for the API connection. Check
        out
        <a
      ...
      <Typography className="mb-16 leading-loose" component="p">
        In order to demonstrate HTTP requests, all of the example backend data is located at
        src/@mock-api, using{" "}
        <a
        ...
        . This way, developers can focus on the frontend app, and once you finish with the frontend,
        create your backend application to provide real API endpoints with real data. @mock-api
        helps you progress faster and know exactly what you will be needing from your API.
      </Typography>

      <Typography className="mb-16 leading-loose" component="p">
        We have created open api definitions and followed this definitions while generating
        @mock-api. You can use the definitions as an example while creating your api, check out:
