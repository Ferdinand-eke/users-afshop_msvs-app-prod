  ...
  return (
    <>
      ...
      <Typography
        ...
        component="p"
      >
        Although most people don't require multi-language capabilities for their apps, we have
        chosen NOT to incorporate translations into every application. To get a glimpse of how
        translations work in practice, try visiting the Mail app and altering the language in the
        Toolbar. This is the only app specifically configured with translations for demonstration
        purposes. If you wish to delve into the details, you can review the source code for an
      ...
      <Typography className="mb-16" component="p">
        To use the translations, create a translation file called <code>i18n/en.ts</code> within the
        folder of the app you would like to use them with. For example, to use the translations in
        the Mail app, create this file inside the <code>apps/mail</code> folder.
      </Typography>
      ...
      <Typography className="mb-16" component="p">
        ...
        setting in the file <code>src/i18n.ts</code>
      </Typography>
