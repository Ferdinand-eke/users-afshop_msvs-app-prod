...
function AutocompleteDoc(props) {
  return (
    <>
      ...
      <ol>
        <li>
          The value for the textbox must be chosen from a predefined set of allowed values, for
          example a location field must contain a valid location name:{" "}
          <a href="#combo-box">combo box</a>.
        </li>
        <li>
          The textbox may contain any arbitrary value, but it is advantageous to suggest possible
          values to the user, for example a search field may suggest similar or previous searches to
          save the user time: <a href="#free-solo">free solo</a>.
        </li>
      </ol>
      <Typography className="text-14 mb-32" component="div">
...
`}
      ...
      <Typography className="text-14 mb-32" component="div">
        If you control the <code>value</code>, make sure it&#39;s referentially stable between
        renders. In other words, the reference to the value shouldn&#39;t change if the value itself
        doesn&#39;t change.
      </Typography>
...
`}
      ...
      <Typography className="text-14 mb-32" component="div">
        In the first example, <code>allValues.filter</code> is called and returns{" "}
        <strong>a new array</strong> every render. The fix includes memoizing the value, so it
      ...
      <Typography className="text-14 mb-32" component="div">
        ...
        suggestions, for example Google search or react-autowhatever.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
          name="FreeSolo.js"
...
`}
      ...
      <Typography className="text-14 mb-32" component="div">
        :::warning If you&#39;re using a custom input component inside the Autocomplete, make sure
        that you forward the ref to the underlying DOM element. :::
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
      ...
      <Typography className="text-14 mb-32" component="div">
        To globally customize the Autocomplete options for all components in your app, you can use
        the{" "}
        <a href="/material-ui/customization/theme-components/#theme-default-props">
          theme default props
        </a>{" "}
        and set the <code>renderOption</code> property in the <code>defaultProps</code> key. The{" "}
        <code>renderOption</code> property takes the <code>ownerState</code> as the fourth
        parameter, which includes props and internal component state. To display the label, you can
        use the <code>getOptionLabel</code> prop from the <code>ownerState</code>. This approach
        enables different options for each Autocomplete component while keeping the options styling
        consistent.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
