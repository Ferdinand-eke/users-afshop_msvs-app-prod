...
function SliderDoc(props) {
  return (
    <>
      ...
      <Typography className="text-14 mb-32" component="div">
        You can change the default step increment. Make sure to adjust the <code>shiftStep</code>{" "}
        prop (the granularity with which the slider can step when using Page Up/Down or Shift +
        Arrow Up/Down) to a value divadable with the <code>step</code>.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
      ...
      <Typography className="text-14 mb-32" component="div">
        <strong>WARNING</strong>: Chrome, Safari and newer Edge versions that is any browser based
        on WebKit exposes <code>{`<Slider orientation="vertical" />`}</code> as horizontal (
      ...
      <Typography className="text-14 mb-32" component="div">
        You can customize your slider by adding and repositioning marks for minimum and maximum
        values.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
