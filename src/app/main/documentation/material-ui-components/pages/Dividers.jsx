  ...
  return (
    <>
      ...
      <Typography className="text-14 mb-32" component="div">
        The Material UI Divider component renders as a dark gray <code>{`<hr>`}</code> by default,
        and features several useful props for quick style adjustments.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
...
`}
      ...
      <Typography className="text-14 mb-32" component="div">
        Use the <code>flexItem</code> prop to display the Divider when it&#39;s being used in a flex
        container.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
      ...
      <Typography className="text-14 mb-32" component="div">
        When using the Divider to separate items in a List, use the <code>component</code> prop to
        render it as an <code>{`<li>`}</code>—otherwise it won&#39;t be a valid HTML element.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
      ...
      <Typography className="text-14 mb-32" component="div">
        Due to its implicit role of <code>separator</code>, the Divider, which is a{" "}
        <code>{`<hr>`}</code> element, will be announced by screen readers as a &quot;Horziontal
        Splitter&quot; (or vertical, if you&#39;re using the <code>orientation</code> prop).
      </Typography>
      <Typography className="text-14 mb-32" component="div">
...
`}
      ...
      <Typography className="text-14 mb-32" component="div">
        If you&#39;re using the Divider to wrap other elements, such as text or chips, we recommend
        changing its rendered element to a plain <code>{`<div>`}</code> using the{" "}
        <code>component</code> prop, and setting <code>{`role="presentation"`}</code>. This ensures
        that it&#39;s not announced by screen readers while still preserving the semantics of the
        elements inside it.
      </Typography>
