  ...
  return (
    <>
      ...
      <Typography className="text-14 mb-32" component="div">
        ...
        <code>disabled</code>, <code>type</code>, etc. as well as a <code>helperText</code> which is
...
`}
      ...
      <Typography className="text-14 mb-32" component="div">
        Global styles for the auto-fill keyframes are injected and removed on each mount and
        unmount, respectively. If you are loading a large number of Text Field components at once,
        it might be a good idea to change this default behavior by enabling{" "}
        <a href="/material-ui/api/input-base/#input-base-prop-disableInjectingGlobalStyles">
          <code>disableInjectingGlobalStyles</code>
        </a>{" "}
        in <code>MuiInputBase</code>. Make sure to inject <code>GlobalStyles</code> for the
        auto-fill keyframes at the top of your application.
      </Typography>
...
`}
      ...
      <Typography className="text-14 mb-32" component="div">
        :::warning We do not recommend using <code>{`type="number"`}</code> with a Text Field due to
      ...
      <ul className="space-y-16">
        ...
        <li>
          <Typography className="text-14 mb-32" component="div">
            the functionality of scrolling to increment/decrement the number can cause accidental
        ...
        <li>
          <Typography className="text-14 mb-32" component="div">
            ...
            for a more detailed explanation of the limitations of{" "}
      ...
      <Typography className="text-14 mb-32" component="div">
        You can follow{" "}
        <a href="https://github.com/mui/material-ui/issues/19154">this GitHub issue</a> to track the
        progress of introducing the Number Input component to Material UI.
      </Typography>
      <Typography className="text-16 mt-20 mb-10 font-700" component="h3">
        Helper text
      </Typography>
      ...
      <Typography className="text-14 mb-32" component="div">
        ...
        libraries. The same concept could be applied to, for example{" "}
...
`}
      ...
      <ul className="space-y-16">
        ...
        <li>
          <a href="https://github.com/dohomi/react-hook-form-mui">react-hook-form-mui</a>:
