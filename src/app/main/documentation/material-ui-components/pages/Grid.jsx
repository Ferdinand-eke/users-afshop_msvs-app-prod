...
function GridDoc(props) {
  return (
    <>
      ...
      <Typography className="text-14 mb-32" component="div">
        A value passed to any given breakpoint also applies to all wider breakpoints (if they have
        no values explicitly defined). For example, <code>{`xs={12}`}</code> sizes a component to
        occupy the full width of its parent container, regardless of the viewport size.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
          name="BasicGrid.js"
...
`}
      ...
      <Typography className="text-14 mb-32" component="div">
        ...
        easily use <a href="/system/grid/">MUI System</a> and CSS Grid to layout your pages.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
          name="CSSGrid.js"
