...
function AvatarsDoc(props) {
  return (
    <>
      ...
      <Typography className="text-14 mb-32" component="div">
        Set the <code>renderSurplus</code> prop as a callback to customize the surplus avatar. The
        callback will receive the surplus number as an argument based on the children and the{" "}
        <code>max</code> prop, and should return a <code>React.ReactNode</code>.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        The <code>renderSurplus</code> prop is useful when you need to render the surplus based on
