  ...
  return (
    <>
      ...
      <Typography className="text-14 mb-32" component="div">
        The Material UI Accordion component includes several complementary utility components to
        handle various use cases:
      </Typography>
      <ul className="space-y-16">
        <li>Accordion: the wrapper for grouping related components.</li>
        <li>
          Accordion Summary: the wrapper for the Accordion header, which expands or collapses the
...
`}
      ...
      <Typography className="text-14 mb-32" component="div">
        Use the <code>expandIcon</code> prop on the Accordion Summary component to change the expand
        indicator icon. The component handles the turning upside-down transition automatically.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
      ...
      <Typography className="text-14 mb-32" component="div">
        Use the <code>defaultExpanded</code> prop on the Accordion component to have it opened by
        default.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
      ...
      <Typography className="text-14 mb-32" component="div">
        Use the <code>slots.transition</code> and <code>slotProps.transition</code> props to change
        the Accordion&#39;s default transition.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
      ...
      <Typography className="text-14 mb-32" component="div">
        Use the <code>disabled</code> prop on the Accordion component to disable interaction and
        focus.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
      ...
      <div className="border-1 p-16 rounded-16 my-12">
        <ul className="space-y-16">
          <li>
            A component is <strong>controlled</strong> when it&#39;s managed by its parent using
            props.
          </li>
          <li>
            A component is <strong>uncontrolled</strong> when it&#39;s managed by its own local
            state.
          </li>
        </ul>
        <Typography className="text-14 mb-32" component="div">
      ...
      <Typography className="text-14 mb-32" component="div">
        Use the <code>expanded</code> prop with React&#39;s <code>useState</code> hook to allow only
        one Accordion item to be expanded at a time. The demo below also shows a bit of visual
        customziation.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
      ...
      <Typography className="text-14 mb-32" component="div">
        The Accordion content is mounted by default even if it&#39;s not expanded. This default
        behavior has server-side rendering and SEO in mind.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        If you render the Accordion Details with a big component tree nested inside, or if you have
        many Accordions, you may want to change this behavior by setting <code>unmountOnExit</code>{" "}
        to <code>true</code> inside the <code>slotProps.transition</code> prop to improve
        performance:
      </Typography>
...
`}
      ...
      <Typography className="text-14 mb-32" component="div">
        ...
        <a href="https://www.w3.org/WAI/ARIA/apg/patterns/accordion/">
          WAI-ARIA guidelines for accordions
        </a>{" "}
        recommend setting an <code>id</code> and <code>aria-controls</code>, which in this case
        would apply to the Accordion Summary component. The Accordion component then derives the
        necessary <code>aria-labelledby</code> and <code>id</code> from its content.
      </Typography>
...
`}
      ...
      <Typography className="text-14 mb-32" component="div">
        The Accordion component is composed of a root <code>{`<div>`}</code> that houses interior
        elements like the Accordion Summary and other optional components (such as buttons or
        decorators).
      </Typography>
