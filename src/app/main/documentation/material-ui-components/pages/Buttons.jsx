...
`}
      ...
      <Typography className="text-14 mb-32" component="div">
        ...
        don&#39;t need. See the{" "}
        <a href="/material-ui/customization/palette/#custom-colors">Adding new colors</a> examples
        for more info.
      </Typography>
      <Typography className="text-24 mt-24 mb-10 font-700" component="h2">
        Sizes
      ...
      <Typography className="text-14 mb-32" component="div">
        ...
        <a href="/material-ui/integrations/routing/#button">more detailed guide</a>.
      </Typography>
      <Typography className="text-24 mt-24 mb-10 font-700" component="h2">
        Limitations
      </Typography>
