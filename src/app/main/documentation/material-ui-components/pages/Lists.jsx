...
function ListsDoc(props) {
  return (
    <>
      ...
      <Typography className="text-14 mb-32" component="div">
        Lists present information in a concise, easy-to-follow format through a continuous, vertical
        index of text or images.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
      ...
      <ul className="space-y-16">
        <li>
          List: a wrapper for list items. Renders as a <code>{`<ul className="space-y-16">`}</code>{" "}
          by default.
        </li>
        <li>
...
`}
      ...
      <Typography className="text-14 mb-32" component="div">
        You can find a{" "}
        <a href="/material-ui/integrations/routing/#list">
