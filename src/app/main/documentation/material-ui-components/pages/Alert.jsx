...
function AlertDoc(props) {
  return (
    <>
      ...
      <Typography className="text-14 mb-32" component="div">
        The Material UI Alert component includes several props for quickly customizing its styles to
        provide immediate visual cues about its contents.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
          name="SimpleAlert.js"
      ...
      <Typography className="text-14 mb-32" component="div">
        ...
        <a href="https://www.w3.org/WAI/ARIA/apg/patterns/alertdialog/">ARIA</a>), which{" "}
        <em>are</em> intended to interrupt the user to obtain a response. Use the Material UI{" "}
        <a href="https://mui.com/material-ui/react-dialog/">Dialog</a> component if you need this
        behavior.
      </Typography>
      <Typography className="text-24 mt-24 mb-10 font-700" component="h2">
        Basics
...
`}
      ...
      <Typography className="text-14 mb-32" component="div">
        ...
        <code>success</code> (the default), <code>info</code>, <code>warning</code>, and{" "}
        <code>error</code>–with corresponding icon and color combinations for each:
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
          name="BasicAlerts.js"
      ...
      <Typography className="text-14 mb-32" component="div">
        :::warning When using an outlined Alert with the{" "}
        <a href="/material-ui/react-snackbar/">Snackbar</a> component, background content will be
        visible and bleed through the Alert by default. You can prevent this by adding{" "}
        <code>{`bgcolor: 'background.paper'`}</code> to{" "}
...
`}
      ...
      <Typography className="text-14 mb-32" component="div">
        Check out the{" "}
        <a href="/material-ui/react-snackbar/#customization">Snackbar—customization</a> doc for an
      ...
      <Typography className="text-14 mb-32" component="div">
        Add an action to your Alert with the <code>action</code> prop. This lets you insert any
        element—an HTML tag, an SVG icon, or a React component such as a Material UI Button—after
        the Alert&#39;s message, justified to the right.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        If you provide an <code>onClose</code> callback to the Alert without setting the{" "}
        <code>action</code> prop, the component will display a close icon (&#x2715;) by default.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
      ...
      <Typography className="text-14 mb-32" component="div">
        ...
        prop, your <code>icon</code> can be an HTML element, an SVG icon, or a React component. Set
        this prop to <code>false</code> to remove the icon altogether.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        ...
        , you can use the <code>iconMapping</code> prop instead. You can define this prop globally
        by customizing your app&#39;s theme. See{" "}
...
`}
      ...
      <Typography className="text-14 mb-32" component="div">
        You can nest this component above the message in your Alert for a neatly styled and properly
        aligned title, as shown below:
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
      ...
      <Typography className="text-14 mb-32" component="div">
        ...
        <a href="/material-ui/transitions/#collapse">Collapse</a> to add motion to an Alert&#39;s
        entrance and exit.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
      ...
      <ul className="space-y-16">
        <li>
          Because alerts are not intended to interfere with the use of the app, your Alert component
          should <em>never</em> affect the keyboard focus.
        </li>
        <li>
          If an alert contains an action, that action must have a <code>tabindex</code> of{" "}
          <code>0</code> so it can be reached by keyboard-only users.
        </li>
        <li>
          ...
          can make your app inaccessible to users who need extra time to understand or locate the
          alert.
        </li>
        <li>
        ...
        <li>
          Dynamically rendered alerts are announced by screen readers; alerts that are already
          present on the page when it loads are <em>not</em> announced.
        </li>
        <li>
          Color does not add meaning to the UI for users who require assistive technology. You must
          ensure that any information conveyed through color is also denoted in other ways, such as
          within the text of the alert itself, or with additional hidden text that&#39;s read by
          screen readers.
        </li>
      </ul>
      <Typography className="text-24 mt-24 mb-10 font-700" component="h2">
      ...
      <Typography className="text-14 mb-32" component="div">
        The Alert component is composed of a root <a href="/material-ui/react-paper/">Paper</a>{" "}
        component (which renders as a <code>{`<div>`}</code>) that houses an icon, a message, and an
        optional <a href="#actions">action</a>:
      </Typography>
