...
function MasonryDoc(props) {
  return (
    <>
      ...
      <Typography className="text-14 mb-32" component="div">
        This example demonstrates the use of the <code>sequential</code> to configure the sequential
        order. With <code>sequential</code> enabled, items are added in order from left to right
        rather than adding to the shortest column.
      </Typography>
      <Typography className="text-14 mb-32" component="div">
        <FuseExample
          name="Sequential.js"
      ...
      <div className="border-1 p-16 rounded-16 my-12">
        <Typography className="text-14 mb-32" component="div">
          ...
          mentioning that items are not added to the shortest column in case of server-side
          rendering.
        </Typography>
      </div>
