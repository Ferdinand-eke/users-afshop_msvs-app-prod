  ...
  return (
    <>
      ...
      <Typography className="text-14 mb-32" component="div">
        ...
        focused (for example when tabbing) releasing (<code>keyup</code> event){" "}
        <code>Backspace</code> or <code>Delete</code> will call the <code>onDelete</code> handler
        while releasing <code>Escape</code> will blur the Chip.
      </Typography>
    </>
  );
}
