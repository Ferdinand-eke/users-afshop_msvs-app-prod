  ...
  return (
    <>
      ...
      <Typography className="text-14 mb-32" component="div">
        Material UI uses the <a href="https://fonts.google.com/specimen/Roboto">Roboto</a> font by
        default. Add it to your project via Fontsource, or with the Google Fonts CDN.
      </Typography>
...
`}
      ...
      <div className="border-1 p-16 rounded-16 my-12">
        <Typography className="text-14 mb-32" component="div">
          ...
          Material UI&#39;s default typography configuration relies only on the 300, 400, 500, and
          700 font weights.
        </Typography>
      </div>
      ...
      <Typography className="text-14 mb-32" component="div">
        To install Roboto through the Google Web Fonts CDN, add the following code inside your
        project&#39;s <head /> tag:
      </Typography>
...
`}
      ...
      <Typography className="text-14 mb-32" component="div">
        ...
        <a href="https://m2.material.io/design/typography/#type-scale">
      ...
      <Typography className="text-14 mb-32" component="div">
        In some situations you might not be able to use the Typography component. Hopefully, you
      ...
      <Typography className="text-14 mb-32" component="div">
        To change the underlying element for a one-off situation, like avoiding two <code>h1</code>{" "}
        elements in your page, use the <code>component</code> prop:
      </Typography>
...
`}
      ...
      <Typography className="text-14 mb-32" component="div">
        ...
        properties. You can use them as prop directly on the component. For example, here&#39;s how
        you&#39;d add a margin-top:
      </Typography>
...
`}
      ...
      <ul className="space-y-16">
        ...
        <li>
          ...
          <a href="/material-ui/customization/typography/#font-size">relative units (rem)</a>,
          instead of pixels, to accommodate the user&#39;s browser settings.
        </li>
        <li>
          <strong>Heading hierarchy</strong>. Based on{" "}
          <a href="https://www.w3.org/WAI/tutorials/page-structure/headings/">the W3 guidelines</a>,
