  ...
  return (
    <>
      ...
      <div className="mx-16 my-32">
        <Typography className="flex text-15 mb-10 font-700" variant="h6">
          B.1. Choose which version you want to install
        </Typography>

        <Typography component="div">
          When you unzip the .zip file you have downloaded from Themeforest, you will find 4
          additional .zip files along with other files. You can choose TS or JS versions and both
          versions has demo and skeleton options.
        </Typography>
        ...
        <Typography className="flex text-15 mt-32 mb-10 font-700" variant="h6">
          B.2. Unzip
        </Typography>
