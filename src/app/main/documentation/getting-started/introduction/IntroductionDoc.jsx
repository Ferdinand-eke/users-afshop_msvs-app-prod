  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="p">
        ...
        is a modern frontend build tool created to streamline the development of web applications.
        It enhances the development experience by offering fast server start and hot module
        replacement, eliminating the need for complex setup and configuration tasks.
      </Typography>
    </>
  );
}
