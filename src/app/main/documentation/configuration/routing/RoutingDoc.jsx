...
function RoutingDoc() {
  return (
    <>
      ...
      <Typography className="mb-16" component="p">
        Fuse React follows a modular approach and is based on route settings determined from config
        files.
      </Typography>

      <Typography className="mb-16" component="p">
        For example, have a look at the code in <code>MailboxAppConfig.tsx</code>. Here you can
      ...
      <Typography className="mb-16" component="p">
        The routes are then generated in <code>app/configs/routesConfig</code>, as seen in the code
        snippet below:
      </Typography>
