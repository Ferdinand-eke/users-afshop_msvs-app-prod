  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="p">
        The theme navigation is located in the file <code>app/configs/navigationConfig.ts</code>,
      ...
      <Typography className="mb-16" component="p">
        Navigation items can be modified, removed, and added using various redux actions from
        anywhere within the app.
      </Typography>

      <Typography className="mb-16" component="p">
        For more information on FuseNavigation components, redux actions, and item types, check out
        the section
