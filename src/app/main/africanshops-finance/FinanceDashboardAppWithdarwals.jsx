...
import { Button, ListItemIcon, MenuItem, Paper, Typography } from "@mui/material";
...
function FinanceDashboardAppWithdarwals() {
  ...
  /****used above for wallet withdrawals */
  ...
  return (
    <FusePageSimple
      header={<FinanceDashboardAppHeader shopData={shopData} isLoading={shopDataLoading} />}
      content={
