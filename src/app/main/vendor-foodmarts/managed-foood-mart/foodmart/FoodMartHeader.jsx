			...
			<div className="flex flex-col items-start space-y-8 sm:space-y-0 w-full sm:max-w-full min-w-0">
				...
				>
					<Typography
						...
						component={Link}
						role="button"
						to="/foodmarts/managed-foodmerchants"
						color="inherit"
					>
						<FuseSvgIcon size={20}>
							{theme.direction === 'ltr'
						...
						<span className="flex mx-4 font-medium">Food Mart Listing</span>
					</Typography>
				</motion.div>
