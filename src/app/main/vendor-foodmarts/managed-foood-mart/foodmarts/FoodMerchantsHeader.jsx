			...
			<div className="flex flex-1 items-center justify-end space-x-8">
				...
				>
					<Button
						...
						to="/foodmarts/managed-foodmerchants/new"
						size={isMobile ? 'small' : 'medium'}
					>
						<FuseSvgIcon size={20}>heroicons-outline:plus</FuseSvgIcon>
						<span className="mx-4 sm:mx-8">Add Food Mart To Be Listed</span>
					</Button>
				</motion.div>
			</div>
		</div>
...
export default FoodMerchantsHeader;
