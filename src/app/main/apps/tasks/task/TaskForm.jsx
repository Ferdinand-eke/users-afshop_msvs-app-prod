...
function TaskForm() {
  ...
  useDeepCompareEffect(() => {
    if (
      !(!isValid || _.isEmpty(form) || !task || routeParams.id === "new") &&
      !_.isEqual(task, form)
    ) {
      onSubmit(form);
    }
  ...
  function onSubmitNew(data) {
    createTask(data)
      ...
      .catch((rejected) => {
        dispatch(
          showMessage({ message: `Error creating task item ${rejected}`, variant: "error" }),
        );
      });
  }
      ...
      <div className="relative flex flex-col flex-auto items-center px-24 sm:px-48">
        <div className="flex items-center justify-between border-b-1 w-full py-24 mt-16 mb-32">
          ...
          <div className="flex items-center">
            ...
            <IconButton component={NavLinkAdapter} to="/apps/tasks" size="large">
