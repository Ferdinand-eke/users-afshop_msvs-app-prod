      ...
      <Paper className="h-full w-full px-16 py-8 ltr:border-r-1 rtl:border-l-1 sm:h-auto sm:w-auto sm:rounded-2xl sm:p-48 sm:shadow md:flex md:h-full md:w-1/2 md:items-center md:justify-end md:rounded-none md:p-64 md:shadow-none">
        <CardContent className="mx-auto w-full max-w-320 sm:mx-0 sm:w-320">
          ...
          <Alert icon={false} severity="info" className="mt-24 px-16 text-13 leading-relaxed">
            You have been inited to join <b>CharizHomes</b> as an admin. By forging on with this
            form and clicking on the "Accept Invite" button, you agree to all terms and conditions
            as stated above.
          </Alert>
