        ...
        <Card className="mx-auto w-xl rounded-2xl p-64 shadow print:w-auto print:rounded-none print:bg-transparent print:shadow-none">
          <CardContent>
            ...
            <div className="mt-48 grid grid-cols-12 gap-x-4">
              <div className="col-span-8 text-md font-medium" color="text.secondary">
                SERVICE
              </div>
              <div className="text-right text-md font-medium" color="text.secondary">
                RATE
              </div>
              <div className="text-right text-md font-medium" color="text.secondary">
                QTY
              </div>
              <div className="col-span-2 text-right text-md font-medium" color="text.secondary">
                TOTAL
              </div>
            ...
            <div className="mt-64">
              ...
              <div className="mt-16 flex items-start">
                <img className="flex-0 mt-8 w-40" src="assets/images/logo/logo.svg" alt="logo" />
