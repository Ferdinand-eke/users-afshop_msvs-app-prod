      ...
      <div className="bg-gray-800 text-center p-6 sm:p-10 rounded-lg shadow-lg max-w-xs sm:max-w-md mx-auto">
        <div className="flex justify-center mb-4">
          <div className="bg-green-500 rounded-full p-4">
            ...
            <FuseSvgIcon className="fas fa-check text-white text-2xl">
        ...
        <br />
        <p className="text-gray-400  text-[10px] justify-start">
          An email has been sent to {user?.email} with an invoice to confirm this purchase.
        </p>
        <Button
