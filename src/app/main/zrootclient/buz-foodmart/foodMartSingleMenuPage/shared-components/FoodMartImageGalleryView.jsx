...
/**
 * FoodMartImageGalleryView Modal Component
 * Full-screen modal for viewing menu images with integrated review/comment functionality
 */
function FoodMartImageGalleryView({ open, onClose, images = [], menuData = {} }) {
  ...
  const [reviews, setReviews] = useState([
    {
      ...
      timeAgo: "2d",
      content: "Delicious food! Exactly as described and arrived hot and fresh.",
      rating: 5,
      likes: 3,
      isAuthor: false,
      replies: [
