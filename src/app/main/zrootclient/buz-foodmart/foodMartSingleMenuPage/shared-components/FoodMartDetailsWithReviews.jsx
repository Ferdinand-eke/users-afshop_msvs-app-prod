...
/**
 * FoodMartDetailsWithReviews Component
 * Displays menu item details and reviews in tabbed interface
 */
const FoodMartDetailsWithReviews = ({ menuData }) => {
  ...
  const [reviews, setReviews] = useState([
    {
      ...
      timeAgo: "3d",
      content: "Amazing dish! The flavors were perfectly balanced and portion size was generous.",
      rating: 5,
      likes: 0,
      isAuthor: false,
      replies: [
        {
          ...
          authorImage: "https://placehold.co/40x40",
          timeAgo: "2d",
          content: "Thank you for your wonderful feedback! We're delighted you enjoyed your meal.",
          isAuthor: true,
        },
      ],
    },
  ...
  return (
    <div className="px-4 py-4 rounded h-auto min-h-fit">
      {/* Tab Headers */}
      ...
      {active === 1 ? (
        ...
        >
          <div className={`${isMobile ? "p-4" : "p-8"}`}>
            ...
            >
              {menuData?.description || "Menu item description not available."}
            </Typography>
          ...
          {!user?.email && (
            <>
              <div className={`${isMobile ? "p-4" : "p-8"} border-b`}>
                ...
                >
                  See what other customers are saying about this dish.
                </Typography>
