      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="mt-32 grid w-full gap-24 sm:grid-cols-3">
          <div className="sm:col-span-3">
            <Alert severity="info">
              Changing the plan will take effect immediately. You will be charged for the rest of
              the current month.
            </Alert>
          </div>
          <Controller
        ...
        <div className="w-full">
          ...
          <Typography color="text.secondary">
            Update your billing information. Make sure to set your location correctly as it could
