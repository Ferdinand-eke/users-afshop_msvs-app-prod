      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Search Bar */}
            <Box
              sx={{ p: { xs: 1.5, md: 2 }, bgcolor: "white", borderBottom: "1px solid #e5e7eb" }}
            >
              <TextField
                fullWidth
                  ...
                  <React.Fragment key={conversation.id}>
                    <ListItem
                      ...
                      sx={{
                        ...
                        px: { xs: 1.5, md: 2 },
                        bgcolor:
                          selectedConversation?.id === conversation.id ? "#f3f4f6" : "transparent",
                        cursor: "pointer",
                        "&:hover": {
                          bgcolor: "#f9fafb",
                        },
                    ...
                    >
                      ...
                      <IconButton
                        size="small"
                        sx={{ alignSelf: "flex-start", display: { xs: "none", sm: "inline-flex" } }}
                      >
