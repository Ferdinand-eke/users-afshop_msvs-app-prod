...
function AcquisitionContent(props) {
  ...
  } = useGetAcquisitionStatus(offerId, propertyId);
  ...
  const handlePaymentSubmit = async () => {
    ...
    if (!documents.identityDocument || !documents.proofOfAddress) {
      alert(
        "Please upload both required documents (ID and Proof of Address) before submitting payment",
      );
      return;
    }
    ...
    try {
      ...
      const acquisitionData = {
        ...
        userName:
          user?.name || `${user?.data?.firstName || ""} ${user?.data?.lastName || ""}`.trim(),
                ...
                <CardContent className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="p-4 bg-gradient-to-r from-orange-50 to-orange-100 rounded-lg border-2 border-orange-300">
                      <Typography
                        variant="caption"
                        className="text-orange-800 font-semibold block mb-1"
                      >
                        AMOUNT TO PAY
                      </Typography>
                  ...
                  <Alert severity="warning" className="mt-4">
                    <Typography variant="body2" className="font-semibold">
                      ...
                      Important: Only payments to this account will be recognized. Do not send money
                      to any individual.
                    </Typography>
                  </Alert>
                </CardContent>
                ...
                <CardContent className="p-6">
                  ...
                  {paymentSubmitted ? (
                    <Alert severity="success" icon={<i className="fas fa-check-circle"></i>}>
                      <Typography variant="body2" className="font-semibold">
                        Payment proof submitted successfully! Our finance team will verify your
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 transition-colors">
                          ...
                          <Typography variant="caption" className="text-gray-600 block mb-3">
                            Utility bill, bank statement, or rental agreement (not older than 3
                            months)
                          </Typography>
                          <input
                            type="file"
                      ...
                      {(!documents.identityDocument || !documents.proofOfAddress) && (
                        <Alert severity="warning" className="mt-2">
                          <Typography variant="caption">
                            Please upload both required documents (ID and Proof of Address) before
                            submitting
                          </Typography>
                        </Alert>
                      )}
                ...
                <Card className="shadow-lg">
                  <CardContent className="p-6">
                    ...
                    {documentsSubmitted ? (
                      <Alert severity="success" icon={<i className="fas fa-check-circle"></i>}>
                        <Typography variant="body2" className="font-semibold">
                          Documents submitted successfully! Our legal team will review them within
                          3-5 business days.
                        </Typography>
                      </Alert>
                    ) : (
                      <div className="space-y-6">
                        ...
                        <div>
                          <Typography
                            variant="caption"
                            className="text-gray-800 font-bold block mb-3 uppercase"
                          >
                        ...
                        <Button
                          ...
                          disabled={
                            !documents.identityDocument || !documents.proofOfAddress || isUploading
                          }
            ...
            {paymentSubmitted && documentsSubmitted && (
              ...
              >
                ...
                >
                  ...
                  <Typography variant="body2">
                    Thank you for submitting all required information. Our teams will now process
                    your application:
                  </Typography>
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    <li>Finance team will verify your payment (24-48 hours)</li>
                  ...
                  <Card key={index} variant="outlined" className="p-3">
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs={12} sm={6}>
                        ...
                        <Typography variant="body2">{payment.bankName || "N/A"}</Typography>
                      </Grid>
                      <Grid item xs={12} sm={6}>
                        <Typography variant="caption" className="text-gray-600 font-semibold block">
                          Status
