      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
          {[...Array(50)].map((_, i) => {
            ...
            const size =
              Math.random() > 0.5 ? "w-4 h-4" : Math.random() > 0.3 ? "w-5 h-5" : "w-6 h-6";
            ...
            <div className="max-w-lg mx-auto md:mx-0 md:pl-8">
              ...
              <motion.div variants={itemVariants}>
                <p className="text-gray-600 mb-2 text-lg">
                  ...
                  <span className="font-semibold text-orange-600">Africanshops Homes</span>,{" "}
                  {userName}!
                </p>
                <p className="text-gray-600 mb-6">
                  Your reservation has been confirmed. We look forward to hosting you and ensuring
              ...
              <motion.div variants={itemVariants} className="mb-8">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-xs text-gray-600 text-center">Property selected</span>
                  </div>
                  <div
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-xs text-gray-600 text-center">Payment received</span>
                  </div>
                  <div
                    className="flex-1 h-1 mx-2"
                    style={{
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-xs text-gray-600 text-center">Reservation confirmed</span>
                  </div>
                </div>
              </motion.div>
              ...
              {(checkInDate || checkOutDate || propertyName) && (
                <motion.div variants={itemVariants} className="bg-gray-50 rounded-lg p-4 mb-6">
