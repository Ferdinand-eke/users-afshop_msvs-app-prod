        ...
        <>
                            <div className="flex space-x-4">
                              ...
                              <div className="flex-1">
                                ...
                                <p className="text-[12px]">Booking Fee: {formatCurrency(placedReservation?.totalPrice) }</p>
                               {placedReservation?.isPaid &&  <span className="bg-green-500 text-white text-sm px-2 py-1 rounded">
                                  RESERVATION CONFIRMED
                                </span>}
                                {!placedReservation?.isPaid &&  <span className="bg-red-500 text-white text-sm px-2 py-1 rounded">
                                ...
                                {
                                  !placedReservation?.isCheckIn &&  <Button size="small" className="bg-orange-300 text-black text-sm px-2 py-1 rounded w-full">
                                  Cancel This Reservation
                                </Button>
                                }
                               
                              </div>
                              {placedReservation?.isPaid &&  <Typography 
                              ...
                              size="small" className=" text-orange-500 cursor-pointer">
                                PAY
                              </Typography>}
