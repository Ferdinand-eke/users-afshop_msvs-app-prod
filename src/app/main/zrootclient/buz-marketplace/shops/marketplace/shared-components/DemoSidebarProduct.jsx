    ...
    >
      ...
      >
        <div className="h-full rounded-xl overflow-hidden bg-white">
          <CategoryAndTradehub onFilterChange={onFilterChange} resetRef={categoryResetRef} />
        </div>
      </div>

      {/* Filter Section - 60% */}
      <div className="flex-[6] overflow-y-auto overflow-x-hidden">
        <ProductFilter onFilterChange={onFilterChange} onClearAll={handleClearAllFilters} />
      </div>
    </div>
  );
}
