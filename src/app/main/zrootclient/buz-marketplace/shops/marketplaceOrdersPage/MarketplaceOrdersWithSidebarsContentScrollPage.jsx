...
import useGetAllProducts, { useGetAuthUserOrders } from "app/configs/data/server-calls/auth/userapp/a_marketplace/useProductsRepo";
 ...
 */
function MarketplaceOrdersWithSidebarsContentScrollPage() {
...
export default MarketplaceOrdersWithSidebarsContentScrollPage;
