                ...
                <div className="flex flex-col lg:flex-row">
                  <div className="w-full lg:w-1/2">
                    ...
                    <div className="flex mt-2 space-x-2 overflow-x-auto">
                      <img src="https://placehold.co/100x100" alt="Thumbnail 1" className="w-1/5" />
                      <img src="https://placehold.co/100x100" alt="Thumbnail 2" className="w-1/5" />
                      <img src="https://placehold.co/100x100" alt="Thumbnail 3" className="w-1/5" />
                      <img src="https://placehold.co/100x100" alt="Thumbnail 4" className="w-1/5" />
                      <img src="https://placehold.co/100x100" alt="Thumbnail 5" className="w-1/5" />
                    </div>
                  </div>
                  <div className="w-full lg:w-1/2 lg:pl-4 mt-4 lg:mt-0">
                    ...
                    <h1 className="text-2xl font-bold mt-2">
                      Apple MacBook Pro 14.2" M3 Chip With 8-core CPU, 10-core 8GB - 1TB - Silver -
                      2023
                    </h1>
                    ...
                    <div className="flex items-center mt-2">
                      <span className="text-3xl font-bold text-red-500">₦ 2,999,999</span>
                      <span className="text-gray-500 line-through ml-2">₦ 9,999,999</span>
              ...
              <div className="w-full md:w-9/12 bg-white p-4 border rounded mb-4 md:mb-0">
                ...
                <div className="mb-4">
                  ...
                  <p>
                    ...
                    3-nanometre technology and featuring an all-new GPU architecture, they're the
                    most advanced chips ever built for a personal computer. And each one brings more
                    pro performance and capability.
                  </p>
                </div>
                <div>
                  <h2 className="text-lg font-bold">Outstanding Graphics</h2>
                  <p>
                    Presenting an entirely new class of GPU architecture. And the biggest
                    breakthrough in graphics yet for Apple silicon. Dynamic Caching optimises fast
                    on-chip memory to dramatically increase average GPU utilisation - driving a huge
                    performance boost for the most demanding pro apps and games.
                  </p>
                  <p>
                    Games will look more detailed than ever thanks to hardware-accelerated mesh
                    shading. This brings greater capability and efficiency to geometry processing,
                    enabling games to render more visually complex scenes.
                  </p>
                  <p>
                    The 14-inch MacBook Pro with M3 takes power and speed to the next level, whether
                    it’s on battery or plugged in. With a stunning Liquid Retina XDR display, all
                    the ports you need, and all-day battery life —this pro laptop goes anywhere you
                    need.
                  </p>
                </div>
              </div>
