 ...
 */
function UserModernReversedComingSoonPage() {
        ...
        >
          ...
          <div className="relative z-10 w-full max-w-2xl">
            ...
            <div className="mt-24 text-lg leading-6 tracking-tight text-gray-400">
              This feature is currently in development stage, we hope to be done with this, so you
              can enjoy the possibilities we envisiage to make your experiece here worthwhile.
        ...
        <div className="w-full px-16 py-32 ltr:border-l-1 rtl:border-r-1 sm:w-auto sm:p-48 md:p-64">
          <div className="mx-auto w-full max-w-320 sm:mx-0 sm:w-320">
            ...
            <Typography className="mt-2">
              You will be notified when we are ready? Do keep watch however, so you can get involved
              here as soon this feature is launched!
            </Typography>

            <div className="flex flex-col items-center py-48">
              <FuseCountdown endDate="2025-07-28" />
            </div>
...
export default UserModernReversedComingSoonPage;
